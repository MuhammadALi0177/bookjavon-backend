...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'books.authentication.DemoTokenAuth',
        'books.authentication.TelegramWebAppAuth',
    ],
...
TELEGRAM_MINI_APP_URL = os.environ.get('TELEGRAM_MINI_APP_URL', 'http://localhost:5173')
